...
**До:** задвоенный раздел «Домашнее задание» в черновике после автотранскрибации — пустой заголовок на правильном месте, реальный контент застрял не там.

![До сборки](images/before-cb39.png)

**После:** агент нашёл аномалию, предложил решение, после подтверждения перенёс раздел на нужное место.
